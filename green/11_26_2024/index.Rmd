...
-   better keywords
-   re-ran for full 1873-present span (vs. 1965-present)
-   re-ran at progressively more granular time intervals for each metric
-   nixed topic models (need dynamic topic models)
-   word co-occurrence networks 
    -   words co-occurring with labor keywords in enviro speeches
    -   words co-occurring with enviro keywords in labor speeches
    -   words co-occurring with select labor + enviro keywords in enviro-labor speeches
